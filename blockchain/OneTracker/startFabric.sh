...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang"  ]; then
	...
	CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/OneTracker/javascript
elif [ "$CC_SRC_LANGUAGE" = "typescript" ]; then
	CC_RUNTIME_LANGUAGE=node # chaincode runtime language is node.js
	CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/fabcar/typescript
	echo Compiling TypeScript code into JavaScript ...
	pushd ../chaincode/OneTracker/typescript
	npm install
	npm run build
	popd
...
Next, use the OneTracker applications to interact with the deployed OneTracker contract.
The OneTracker applications are available in multiple programming languages.
